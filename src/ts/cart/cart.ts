...
export const cart = {
  ...
  async updateCart (
    ...
    try {
      ...
      if (cart_behavior === "alert" && openAlert) {
        ...
        // In our snippet the width is animated to 100% over 5 seconds
        setTimeout(() => {
  ...
  //   // Update which edit overlay is shown
  ...
  //     const quickEditContainer = document.getElementById(`js-quickEdit`);
  //     if (quickEditContainer) {
  //       quickEditContainer.innerHTML = responseHtml;
  //       this.loadImages();
  //     } else {
