...
export const globals = {
  ...
  menu_sidebar: app.menu_sidebar,                          // {boolean} To toggle the menu sidebar
  menu_nested: app.menu_nested,                            // {boolean} To check if the menu is nested

  // Account
  account_drawer: app.account_drawer,                      // {boolean} To toggle the account drawer
  ...
  reset_product_zindex: app.reset_product_zindex,          // {boolean} To reset the z-index of the product columns
  ...
  discount_alert: app.discount_alert,                  // {boolean} To toggle the discount overlay
  quick_edit_handle: app.quick_edit_handle,                // {string} The product handle of the product being edited
  cart_drawer_style: app.cart_drawer_style,                // {string} Style of the cart drawer
  ...
  cart_alert_timeout: app.cart_alert_timeout,              // {number} Timeout for the cart alert
